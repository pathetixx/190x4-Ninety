...
export const en = {
  ...
  add: {
    ...
    intervalD: "{d} d",
    intervalDH: "{d} d {r} h",
    errUnrecognized: "Couldn't recognize the input. Paste a link (vless/vmess/trojan/ss/hysteria2/hysteria/tuic/anytls/socks/naive/tt), an http(s):// subscription URL, or a TrustTunnel .toml.",

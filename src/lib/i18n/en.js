...
export const en = {
  ...
  rr: {
    ...
    bypassesNinety: "Bypasses Ninety",
  ...
  settings: {
    ...
    warp: {
      ...
      modeTitle: "WARP mode",
      modeHint: "<b>WARP only</b> — all traffic goes through Cloudflare and your server is not involved. <b>On top of the proxy</b> — first your server, then Cloudflare: the IP will then be from the selected node’s country.",
      grpReg: "Registration",

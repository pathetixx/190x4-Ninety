...
// локальный инбаунд явно. На системный прокси полагаться нельзя: в режимах
// «Прокси» и TUN его нет (в TUN трафик Ninety.exe уходит в direct
// bypass-правилом), а без VPN там может стоять чужой или мёртвый прокси. Без
// явного прокси проверка идёт «напрямую» — у части провайдеров эндпоинты так
// недоступны. Прокси из check()

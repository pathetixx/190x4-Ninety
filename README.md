...
**Нативный VPN-клиент под Windows на движке sing-box.**
Подписки, авто-выбор ноды, обход блокировок, маршрутизация по регионам, системный прокси и TUN. Интерфейс работает на системном WebView2 — отдельный браузер внутрь не зашит, поэтому установщик лёгкий, а памяти ест мало.

const translations = {
  ru: {
    ...
    "feature.sources.copy": "Подписки, standalone-ссылки, TrustTunnel endpoint-файлы и .conf WireGuard/AmneziaWG. Импорт из буфера и deep links держатся в одном пользовательском потоке.",
  ...
  en: {
    ...
    "feature.sources.copy": "Subscriptions, standalone links, TrustTunnel endpoint files and WireGuard/AmneziaWG .conf files. Clipboard import and deep links stay in one user flow.",
